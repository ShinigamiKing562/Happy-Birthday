...
class FishPond {
  ...
  render(ctx) {
    ...
    if (this.opacity > 0) {
      ...
      const hbX = this.isMobile ? this.width / 2 - this.fontSize * 3.5 : this.width / 2 - this.fontSize * 3; 
      const hbY = this.isMobile ? this.vh * 30 : this.height / 2 - this.vh * 20;
  ...
  getLetterLotusPositions() {
    const spacing = this.isMobile ? this.vw * 4.2 : this.vw * 4;
    const startX = this.isMobile ? this.vw * 3 : this.vw * 4;
    const startY = this.isMobile ? this.height - this.vh * 30 : this.height - this.vh * 60;
    const points = [];
